...
export class AIController {
  ...
  @UseGuards(JwtAuthGuard)
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Calculate a match score against supplied job text' })
  async matchScoreText(
    @CurrentUser('id') userId: string,
    @Body() dto: MatchScoreTextDto,
  ) {
    return this.aiService.matchScoreText(userId, dto.resumeId, dto.jobDescription);
  }
  ...
  async optimize(
    ...
    return this.aiService.optimizeResume(userId, dto.resumeId, dto.jobId);
  }
