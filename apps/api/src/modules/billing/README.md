...
- Free: 3 job-discovery runs, 10 tracked applications, 5 AI requests, and
  1 truthful CV optimization per month; 1 stored resume and 5 MB storage.
- Pro ($19/month): 50 job-discovery runs, unlimited tracked applications, and
  500 AI requests per month; unlimited CV optimizations, 5 stored resumes, and
  25 MB storage.
