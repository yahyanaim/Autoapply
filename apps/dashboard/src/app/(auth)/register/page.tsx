...
const registerSchema = z
  .object({
    ...
    password: z.string().min(12, 'Use at least 12 characters').regex(/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])/, 'Include upper and lowercase letters, a number, and @$!%*?&'),
    confirmPassword: z.string(),
    acceptDataProcessing: z.boolean().refine((value) => value, {
    ...
    <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <label className="flex items-start gap-3 text-sm text-gray-700">
          ...
          />
          <span>
            I consent to ApplyAI storing my resume data and sending the minimum
            necessary content to configured AI providers to deliver requested
            features. I can export or delete my data from Settings. See the{' '}
