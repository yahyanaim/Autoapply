...
interface UsageSummary { totalRequests: number; totalCost: number; totalTokens: number }
...
export default function DashboardPage() {
  ...
  const stats = [
    ...
    { label: 'AI requests (30 days)', value: String(usage.data?.totalRequests ?? 0), change: `${usage.data?.totalTokens ?? 0} tokens`, trend: 'neutral' as const },
